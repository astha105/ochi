            ...
            <div className="masker">
              <div className='w-fit flex items-end overflow-hidden'>
                ...
                initial={{width:0}}
                 ...
                 className='mr-[1vw] w-[9vw] h-[5.7vw] rounded-lg relative -top-[1.4vw]  bg-red-500'>
                </motion.div>

                )}
              <h1 className="uppercase text-[9vw] h-full -mb-[3vw] py-[1vw] leading-none font-['Founders_Grotesk_X-Condensed'] font-bold">
                {item}</h1>
              </div>
            </div>
          );
